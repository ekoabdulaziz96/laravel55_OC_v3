        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Contact list
                  {{--     <a href="{{ route('contact.exportPDF') }}" class="btn btn-default pull-right" style="margin-top: -8px;">export PDF</a>
                        <a onclick="eximForm()" class="btn btn-warning pull-right" style="margin-top: -8px;">export/import Excel</a>     --}}
                         <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Contact</a>
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="contact-table" class="table table-striped table-responsive table-bordered">
                        <thead>
                            <tr>
                                <th width="30">No</th>
                                <th>Name</th>
