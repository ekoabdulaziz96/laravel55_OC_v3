...
class StatusController extends Controller
{
    ...
    {      
        ...
        return response()->json([
            'success' => true,
            'message' => 'Status 1 berhasil di hapus'
        ]);
    }
    ...
    public function apiStatus()
    {
        ...
        return Datatables::of($status)
            ->addColumn('nomor', function(){
                    global $nomor;
                    return ++$nomor;
            }) ->addColumn('kategori', function($status){
                $kategori = Kategori::find($status->kategori_id);
           ...
           ->addColumn('action', function($status){
            ...
            ->rawColumns(['nomor','kategori', 'action'])->make(true);
    }
}
